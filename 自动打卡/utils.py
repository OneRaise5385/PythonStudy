...
def send_message(message: str):
    if send_type == 'bark':
        ...
        # http.request(method='GET',url='https://sctapi.ftqq.com/SCT180441TT1BbwRz8C6CWAx12D9BcjDJB.send?title=%s/'%message)
        # http.request(method='GET',url='https://sctapi.ftqq.com/')
        if message == "Congratulations!":
            http.request(method='GET',url='https://sctapi.ftqq.com/SCT180441TT1BbwRz8C6CWAx12D9BcjDJB.send?title=Congratulations!&desp=messagecontent')
        elif message == "Mission Succeed!":
            http.request(method='GET',url='https://sctapi.ftqq.com/SCT180441TT1BbwRz8C6CWAx12D9BcjDJB.send?title=Mission_Succeed!&desp=messagecontent')
        elif message == "Mission Failed!":
            http.request(method='GET',url='https://sctapi.ftqq.com/SCT180441TT1BbwRz8C6CWAx12D9BcjDJB.send?title=Mission_Failed!&desp=messagecontent')
